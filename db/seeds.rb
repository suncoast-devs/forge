...
if Rails.env.development?
  ...
  Project.create([
    {title: "Illustration for Mugs", description: "An illstration of a laptop-using manatee.", bid: 42, deadline_on: 1.week.from_now, requested_by: jason, status: :in_progress},
